# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2016-07-23 21:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated_at', models.DateTimeField(auto_now=True, help_text='Last time the feed has been updated', null=True, verbose_name='Last updated at')),
                ...
                ('extra_data', django.contrib.postgres.fields.jsonb.JSONField(db_index=True, verbose_name='Extra data')),
        ...
        migrations.AddField(
            model_name='entry',
            name='feed',
            field=models.ForeignKey(help_text='Feed this entry belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='entries', to='feed.Feed'),
        ),
    ]
